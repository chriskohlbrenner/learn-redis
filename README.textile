...
p. This code is a fork from <a href="https://github.com/nicodds/learn-redis">this repo</a>, with minor updates since the original was out-of-date.
...
p. Explore the app:
<code>ruby poormenslibrary.rb</code>